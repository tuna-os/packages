...
Source1:        gnome-shell-notify-gnome-session.patch

# Replace Epiphany with Firefox in the default favourite apps list
Patch0: gnome-shell-favourite-apps-firefox.patch

Patch1: gnome-shell-notify-gnome-session.patch

# Some users might have a broken PAM config, so we really need this
# downstream patch to stop trying on configuration errors.
Patch2: 0001-gdm-Work-around-failing-fingerprint-auth.patch
